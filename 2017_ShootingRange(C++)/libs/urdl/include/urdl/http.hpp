...
public:
	...
	explicit request_headers(const std::map<std::string, std::string>& value)
		: value_(value)
	{
	}

	explicit request_headers(std::map<std::string, std::string>&& value)
	...
	void value(const std::map<std::string, std::string>& value)
	{
		value_ = value;
	}
